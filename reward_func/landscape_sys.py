...
os.makedirs("reward_landscape_output", exist_ok=True)
...
def generate_plots(test_case):
    ...
    plt.tight_layout()
    plt.savefig(f"reward_landscape_output/network_plot_{name}.png")
    plt.close(fig)
...
def test_plot_generation():
    ...
    print("All plots saved to reward_landscape_output/ directory")
...
def main():
    ...
    with open(f"reward_landscape_grid_search_results/suffix_{suffix_str}_all_results.pkl", 'wb') as f:
        pickle.dump(results, f)
    
    # Save top 100 results in a more readable format
    top_100 = results[:100]
    with open(f"reward_landscape_grid_search_results/suffix_{suffix_str}_top_100_results.txt", 'w') as f:
    ...
    print(f"All results saved to reward_landscape_grid_search_results/suffix_{suffix_str}_all_results.pkl")
    print(f"Top 100 results saved to reward_landscape_grid_search_results/suffix_{suffix_str}_top_100_results.txt")
